...
import asyncio
from archon.archon.cv_schema_adapter import build_canonical_payload, load_candidats_schema
...
from archon.utils.utils import build_llm_config_from_active_profile
...
async def validate_merged(state: CVState, config: Dict[str, Any]) -> CVState:
    ...
    try:
        from archon.archon.cv_schema_adapter import load_candidats_schema
